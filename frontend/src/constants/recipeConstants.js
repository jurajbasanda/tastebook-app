...
export const RECIPE_USER_REQUEST = 'RECIPE_USER_REQUEST'
export const RECIPE_USER_SUCCESS = 'RECIPE_USER_SUCCESS'
export const RECIPE_USER_FAIL = 'RECIPE_USER_FAIL'
...
export const RECIPE_UPDATE_RESET = 'RECIPE_CREATE_RESET'
